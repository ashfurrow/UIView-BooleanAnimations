Pod::Spec.new do |s|
  ...
  s.authors      = { "Ash Furrow" => "ash@ashfurrow.com", "Orta Therox" => "orta@therox.org", "Laura Brown" => "laurabrown1113@gmail.com" }
  s.platform     = :ios
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/ashfurrow/UIView-BooleanAnimations.git", :tag => "1.0.0" }
